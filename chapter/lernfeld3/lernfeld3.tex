...
\input{chapter/lernfeld3/sections/Zahlensysteme.tex}

% in binär noch kibibyte und kilobyte etc.

% Ethernet Standards und Hardware, Duplex, Multi- und singlemode, shieleded ...., cat
% Wlan standards (mimo, mumimo..., 802.11..., 2,5 und 5 ghz und kanäle)
% dfs und tpc
% übertragungsraten (netto und brutto)
% symbole
% energie... strahlungsleistung
...
% wpa-psk und wpa-enterprise (zu itg ???)
